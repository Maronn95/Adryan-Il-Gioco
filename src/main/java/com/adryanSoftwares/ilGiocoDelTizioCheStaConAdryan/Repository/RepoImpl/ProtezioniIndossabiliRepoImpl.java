...
@Repository
public class ProtezioniIndossabiliRepoImpl implements ProtezioniIndossabiliRepository {

    @Autowired
    private JSONcrudRepository JCRUD;
    @Override
    public ProtezioniIndossabiliEntity selectById(Integer idJSONreq) throws IOException, ParseException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException, NoSuchFieldException, ClassNotFoundException {
       return (ProtezioniIndossabiliEntity) JCRUD.selectById(idJSONreq);    }

    @Override
    public ProtezioniIndossabiliEntity creates(Object entity) throws IOException, ParseException, NoSuchFieldException, ClassNotFoundException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, InstantiationException {
        return (ProtezioniIndossabiliEntity) JCRUD.creates(entity);
    }
    ...
    public Object delete(Integer id) throws IOException, ParseException, InterruptedException, NoSuchFieldException, ClassNotFoundException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, InstantiationException {
        return (ProtezioniIndossabiliEntity) JCRUD.delete(id);
    }
